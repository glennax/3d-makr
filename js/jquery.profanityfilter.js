                ...
                for (i = 0; i < badWords.length; i += 1) {
                    ...
                    if (re.test(nodes[x].nodeValue)) {
                        ...
                        if (options.filter) {
                              ...
                              //rep = '<span class="red">' + nodes[x].nodeValue + '</span>'; 

                                //var repHTML = $.parseHTML(rep);
                              //var nodesHTML = $.parseHTML(nodes[x].nodeValue);

                             // console.log(nodes[x]);

                             //  nodes[x].innerHTML = nodes.childNodes[x].nodeValue.replace(re, repHTML);
